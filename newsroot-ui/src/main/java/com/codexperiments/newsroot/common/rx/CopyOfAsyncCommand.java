...
//
// public class CopyOfAsyncCommand<TParam, TResult> extends Observable<TResult> implements Observer<TParam>, Subscription {
...
//
// public static <TParam, TResult> CopyOfAsyncCommand<TParam, TResult> create(CompositeSubscription pSubscriptions,
// Func1<TParam, Observable<TResult>> pAsyncCommand)
// {
// return new CopyOfAsyncCommand<TParam, TResult>(pSubscriptions, pAsyncCommand, null);
// }
//
...
// // }
//
// protected CopyOfAsyncCommand(CompositeSubscription pSubscriptions,
// final Func1<TParam, Observable<TResult>> pAsyncCommand,
// Func1<TResult, TResult> pAfterCommand)
// {
// super(null);
...
// // }
//
// public Subscription subscribe2(Observer<? super TResult> pObserver) {
