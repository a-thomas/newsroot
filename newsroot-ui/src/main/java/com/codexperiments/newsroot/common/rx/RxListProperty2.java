...
public class RxListProperty2<TView extends View, TItem> implements Observer<ListEvent<TView, TItem>> {
    ...
    RxListProperty2<TView, TItem> create(ListView pListView, Class<TView> pViewClass, Class<TItem> pItemClass)
    {
        return new RxListProperty2<TView, TItem>(pListView, pViewClass, pItemClass);
    }

    protected RxListProperty2(ListView pListView, Class<TView> pViewClass, Class<TItem> pItemClass) {
        mListView = pListView;
    ...
    public RxListProperty2<TView, TItem> register(Action2<? super TView, ? super TItem> pAction) {
