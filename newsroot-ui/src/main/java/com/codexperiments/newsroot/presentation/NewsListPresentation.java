...
//
// public AsyncCommand<Void, TweetPageResponse> findMoreCommand = AsyncCommand.create(new Func1<Void,
...
//
// findMoreCommand.subscribe(new Action1<TweetPageResponse>() {
...
// }
//
// // public AsyncCommand<TimeGap, TweetPageResponse> mFindGapCommand = AsyncCommand.create(new Func1<TimeGap,
// // Observable<TweetPageResponse>>() {
